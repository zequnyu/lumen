...
echo
echo "📚 Your ebooks in ~/lumen-ebooks/ will NOT be deleted"
echo
...
try:
    ...
    if 'mcpServers' in config and 'lumen' in config['mcpServers']:
        ...
        print('✅ Removed Lumen from MCP client configuration')
    else:
        print('ℹ️  Lumen not found in MCP client configuration')
        
except Exception as e:
    print(f'⚠️  Could not modify MCP client config: {e}')
"
fi
...
echo
echo "✅ Lumen uninstall completed!"
echo
echo "📚 Your ebooks in ~/lumen-ebooks/ have been preserved"
echo "🔄 You may need to restart your MCP client for changes to take effect"
echo
